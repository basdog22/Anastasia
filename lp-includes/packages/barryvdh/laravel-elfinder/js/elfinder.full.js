...
elFinder.prototype.commands.info = function() {
	...
	this.tpl = {
        ...
        itemedit   : '<span class="elfinder-edit-link">{editlink}</span>',
	...
	this.exec = function(hashes) {
		...
		title += '<a class="btn btn-info btn-block modal-link" href="'+lara.cms.url+'/backend/assets/edit/'+file.name+'">'+lang_strings.edit+'</a>';
