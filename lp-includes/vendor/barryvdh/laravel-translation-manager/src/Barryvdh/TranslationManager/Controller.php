...
class Controller extends BaseController
{
    ...
    public function getIndex($group = null)
    {
        ...
        $groups = array(''=>\Lang::get('strings.please_select')) + $groups->lists('group', 'group');
        ...
        return \View::make('backend/translations/index')
            ...
            ->with('editUrl', url('backend/translations/edit', array($group)))
